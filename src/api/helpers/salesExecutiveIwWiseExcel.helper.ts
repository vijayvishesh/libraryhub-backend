...
//       productColumnsByNormalized.set(
//         normalizedName,
//         resolveProductColumn(normalizedName, usedKeys),
//       );
//     });
//   });
...
//   const productColumnByNormalized = new Map(
//     productColumns.map(column => [column.normalizedName, column]),
//   );

//   const transformedRows = rows.map(row =>
//     buildTransformedRow(row, productColumns, productColumnByNormalized),
//   );
